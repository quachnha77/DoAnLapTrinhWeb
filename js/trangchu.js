...
var timhieuthem = document.getElementById('btn-tim-hieu-them');
timhieuthem.addEventListener('click', function() {
    window.location.href = 'blog.html';
});
var timhieuthem1 = document.getElementById('btn-tim-hieu-them1');
timhieuthem1.addEventListener('click', function() {
